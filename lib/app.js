...
module.exports = function(opt, loggerCallback){
    ...
    if(process.env.PINGADO_LOCALES && process.env.PINGADO_LOCALES_DIR){
	let locales = process.env.PINGADO_LOCALES.split(" ")
	i18n.configure({
	    locales: locales,
	    directory: process.env.PINGADO_LOCALES_DIR,
	    defaultLocale: locales[0],
	    cookie: 'pingado-locale',
	    queryParameter: 'lang',
	...
	loggerCallback("Setting app without internationalization")
    }
